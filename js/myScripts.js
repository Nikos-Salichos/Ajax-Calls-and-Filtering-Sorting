$(document).ready(function () {
    ...
    function StartApplication(data) {
        ...
        //----Get Availability Property Types------
        ...
        for (var guestRating of GuestRatings.sort()) {
            ...
            if (guestRating == "Very Good") guestRatingDrop.append(`<option value="${guestRating}">Very Good 7 - 8</option>`)
        ...
        function Controller() {
            ...
            if (sortBy) {
                switch (sortBy) {
                    ...
                    case "cityDesc": filteredhotels.sort((a, b) => b.price - a.price); break;
        ...
        //Total Reset
        var resetButton=  $(document).ready(function () {
            $("#submit-reset").bind("click", function () {
                $("input:text").val("");
                $("#rooms-DropDown")[0].selectedIndex = 0;
                $('#maxPrice').find('span').html('max.$ 1800');
                $("#price-Range").val(1800);
                $("#Property-Type-DropDown")[0].selectedIndex = 0;
                $("#Guest-Rating-DropDown")[0].selectedIndex = 0;
                $("#Hotel-Location-DropDown")[0].selectedIndex = 0;
                $("#More-Filters-DropDown")[0].selectedIndex = 0;
                $("#Sort-By-DropDown")[0].selectedIndex = 0;
